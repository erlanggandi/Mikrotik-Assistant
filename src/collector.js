...
const RESOURCES = [
  ...
  { name: 'interfaces/ethernet', command: '/interface/ethernet/print' },
  ...
  { name: 'ip/services', command: '/ip/service/print' },
  ...
  { name: 'ip/dhcp-networks', command: '/ip/dhcp-server/network/print' },
  ...
  { name: 'system/routerboard', command: '/system/routerboard/print' },
  { name: 'system/scripts', command: '/system/script/print' },
  { name: 'system/scheduler', command: '/system/scheduler/print' },
  { name: 'system/logging', command: '/system/logging/print' },
  { name: 'files', command: '/file/print' },
];
